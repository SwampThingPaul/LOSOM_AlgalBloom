...
\caption{\label{tab:tab2}Simple logistic model summary comparing algal bloom potental to lake discharges.}\\
...
\multicolumn{5}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.08in+8\tabcolsep+4\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{AIC: 175; BIC: 181.6}}} \\
...
\begin{longtable}[c]{|p{1.40in}|p{0.88in}|p{1.29in}|p{0.78in}|p{0.79in}}

\caption{\label{tab:tab3}Logistic model summary comparing algal bloom potental to water temperature, C-43 basin and lake discharges.}\\
...
\multicolumn{5}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedleft}p{\dimexpr 5.13in+8\tabcolsep+4\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\textit{(Dispersion parameter for binomial family taken to be 1)}}}} \\





\multicolumn{5}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.13in+8\tabcolsep+4\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{Null deviance: 183.1 on 201 degrees of freedom}}} \\





\multicolumn{5}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.13in+8\tabcolsep+4\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{Residual deviance: 148.2 on 198 degrees of freedom}}} \\





\multicolumn{5}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.13in+8\tabcolsep+4\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{AIC: 156.2; BIC: 169.5}}} \\





\multicolumn{5}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.13in+8\tabcolsep+4\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{McFadden's Pseudo R²: 0.19}}} \\

\endfoot



\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 1.4in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{(Intercept)}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.88in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{-9.625}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.29in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{2.175}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.78in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{-4.424}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.79in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{0.000}}} \\





\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 1.4in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{Water Temp}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.88in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{0.326}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.29in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{0.080}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.78in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{4.088}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.79in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{0.000}}} \\





\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 1.4in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{Lake Discharge}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.88in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{-7.384}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.29in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{3.884}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.78in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{-1.901}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.79in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{0.057}}} \\





\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 1.4in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{Basin Discharge}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.88in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{-4.941}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.29in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{2.681}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.78in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{-1.843}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.79in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{0.065}}} \\
...
\NormalTok{params}\OtherTok{=}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Test.Number=}\FunctionTok{c}\NormalTok{(}\DecValTok{61}\NormalTok{,}\DecValTok{179}\NormalTok{,}\DecValTok{7}\NormalTok{),}
                  \AttributeTok{param=}\FunctionTok{c}\NormalTok{(}\StringTok{"Chla"}\NormalTok{,}\StringTok{"Chla"}\NormalTok{,}\StringTok{"Temp"}\NormalTok{))}
...
\CommentTok{\# Multi{-}parameter Model}
\CommentTok{\# Data prep}
\NormalTok{Chla.region2}\OtherTok{=}\FunctionTok{ddply}\NormalTok{(wq.dat.xtab,}\FunctionTok{c}\NormalTok{(}\StringTok{"monCY"}\NormalTok{,}\StringTok{"month"}\NormalTok{,}\StringTok{"Region"}\NormalTok{),}
\NormalTok{                   summarise,}
                   \AttributeTok{Chla=}\FunctionTok{mean}\NormalTok{(Chla,}\AttributeTok{na.rm=}\NormalTok{T),}
                   \AttributeTok{Temp=}\FunctionTok{mean}\NormalTok{(Temp,}\AttributeTok{na.rm=}\NormalTok{T))}
\NormalTok{Chla.region2}\SpecialCharTok{$}\NormalTok{bloom}\OtherTok{=}\FunctionTok{ifelse}\NormalTok{(Chla.region2}\SpecialCharTok{$}\NormalTok{Chla}\SpecialCharTok{\textgreater{}}\DecValTok{20}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)}

\NormalTok{bloom.region.xtab2}\OtherTok{=}\FunctionTok{merge}\NormalTok{(}\FunctionTok{subset}\NormalTok{(Chla.region2,Region}\SpecialCharTok{==}\StringTok{"CRE"}\NormalTok{),}
\NormalTok{                         q.cre.dat.xtab.mon,}\FunctionTok{c}\NormalTok{(}\StringTok{"monCY"}\NormalTok{,}\StringTok{"month"}\NormalTok{))}

\CommentTok{\# Data Explore}
\FunctionTok{plot}\NormalTok{(bloom}\SpecialCharTok{\textasciitilde{}}\NormalTok{Temp,bloom.region.xtab2)}
\FunctionTok{plot}\NormalTok{(bloom}\SpecialCharTok{\textasciitilde{}}\NormalTok{Lake,bloom.region.xtab2)}
\FunctionTok{plot}\NormalTok{(bloom}\SpecialCharTok{\textasciitilde{}}\NormalTok{C43,bloom.region.xtab2)}

\NormalTok{mod2}\OtherTok{=}\FunctionTok{glm}\NormalTok{(bloom}\SpecialCharTok{\textasciitilde{}}\NormalTok{Temp}\SpecialCharTok{+}\NormalTok{Lake}\SpecialCharTok{+}\NormalTok{C43,bloom.region.xtab2,}\AttributeTok{family=}\StringTok{"binomial"}\NormalTok{)}
\FunctionTok{summary}\NormalTok{(mod2)}
\FunctionTok{confint}\NormalTok{(mod2)}

\CommentTok{\# diagonistics}
\FunctionTok{plot}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(}\FunctionTok{rstandard}\NormalTok{(mod2)),}\FunctionTok{rstandard}\NormalTok{(mod2))}
\FunctionTok{plot}\NormalTok{(mod2,}\AttributeTok{which=}\DecValTok{4}\NormalTok{,}\AttributeTok{id.n=}\DecValTok{5}\NormalTok{);}\CommentTok{\#identify the top five largest values}
...
{\centering \includegraphics[width=1.1\linewidth]{C:/Julian_LaCie/_GitHub/LOSOM_AlgalBloom/Plots/MonitoringMap} 
